...
| 項目 | 數量 | 說明 |
|------|------|------|
| **UI 介面翻譯**（locres）| 226 句 | 主選單、HUD、設定選單、統計、造型、難度、獎牌、修正詞、挑戰、按鍵設定等 |
...
| **UI 介面**（玩家可見的選單、HUD 等）| **~98%**（玩家可見部分）| 226/288 字串已翻 |
...
- ✅ **SHA256 完整性**：`5624B791D9A3D388C186FAA964FE279E9F7C3ED6902B5FB101556575E98976C1`

如果你對安全性有疑慮，可以用 PowerShell 自行驗證：

```powershell
Get-FileHash ".\CrabChampions-WindowsNoEditor_P.pak" -Algorithm SHA256
# 應該輸出：5624B791D9A3D388C186FAA964FE279E9F7C3ED6902B5FB101556575E98976C1
```
